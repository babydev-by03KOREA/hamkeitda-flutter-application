...
class _$FacilityDetailImpl implements _FacilityDetail {
  ...
  @override
  String toString() {
    return 'FacilityDetail(id: $id, name: $name, description: $description, phone: $phone, openHours: $openHours, address: $address, imageUrl: $imageUrl, requiredDocs: $requiredDocs, programs: $programs, fees: $fees, posts: $posts)';
  }
