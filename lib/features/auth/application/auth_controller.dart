...
final authRepositoryProvider = Provider<AuthRepository>((ref) => AuthRepository(AuthApi()));
...
class AuthController extends AsyncNotifier<AppUser?> {
  ...
  Future<AppUser?> build() async {
    ...
    return token != null ? const AppUser(id: 'cached', email: 'cached', role: UserRole.guest) : null;
  }
